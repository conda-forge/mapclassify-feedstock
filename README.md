...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/mapclassify-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mapclassify-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add mapclassify
# for installing globally
pixi global install mapclassify
```
...
It is possible to list all of the versions of `mapclassify` available on your platform:
...
```
pixi search mapclassify --channel conda-forge
```
